...
static uint8_t GetGpioPortNumber(GPIO_TypeDef* gpio_port)
{
    uint8_t i = 0;
    //参数检查
...
static uint8_t GetGpioPinNumber(uint16_t gpio_pin)
{
    uint8_t i = 0;
    //参数检查
